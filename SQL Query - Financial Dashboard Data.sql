...
FROM 'D:\CSV files\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\credit_card.csv'
WITH (
...
FROM 'D:\CSV files\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\customer.csv'
WITH (
    FIELDTERMINATOR = ',',  -- Field delimiter in the CSV
    ROWTERMINATOR = '\n',   -- Row delimiter
    FIRSTROW = 2,           -- Skip the header row
    TABLOCK
);
...
BULK INSERT cc_detail
FROM 'D:\CSV files\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\cc_add1.csv'
WITH (
    FIELDTERMINATOR = ',',  -- Field delimiter in your CSV
    ROWTERMINATOR = '\n',   -- Row delimiter
    FIRSTROW = 2,           -- Skip the header row
...
BULK INSERT cust_detail
FROM 'D:\CSV files\Credit_Card_Financial_Dashboard-main\Credit_Card_Financial_Dashboard-main\cust_add.csv'
WITH (
    FIELDTERMINATOR = ',',  -- Field delimiter in the CSV
    ROWTERMINATOR = '\n',   -- Row delimiter
    FIRSTROW = 2,           -- Skip the header row
